...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (savedName) {
      setName(savedName);
      setStep(3); // ya pasó directamente al paso 3
    } else if (localStorage.getItem("confirmed") === "true") {
      setStep(1); // si confirmó pero no puso nombre, va al paso 1
    }
    ...
    <section className="flex flex-col items-center justify-center gap-6 py-8 md:py-10">
      <div className="inline-block max-w-xl text-center">
            ...
            <div className="grid grid-cols-2 gap-4 mt-6">
              {names.map((n) => (
                <button
                  key={n}
                  className={`px-4 py-2 border rounded-full ${
                    name === n ? "bg-violet-100" : "hover:bg-red-100"
                  }`}
                  onClick={() => {
                    setName(n);
        ...
        {step === 3 && name && (
          <>
            ...
            <div className={subtitle({ class: "mt-4" })}>
              ...
              pensado especialmente para ti. Poco a poco irás descubriendo cosas
              bonitas, dulces y únicas... como tú. ✨
            </div>
            <button
        ...
        {step === 4 && (
          <>
            ...
            <div className={subtitle({ class: "mt-4 text-left" })}>
              Hey, solo quería recordarte que <strong>estoy aquí</strong>... no
              es una declaración, ni una obligación. Es solo un pequeño gesto de
              cariño sincero.
              <br />
              <br />
              Por eso pensé en regalarte <strong>
                fotos estilo Polaroid
              </strong>{" "}
              — momentos tuyos, capturados con ternura y admiración.
              <br />
              <br />
              Mi idea es que cada vez que nos veamos, pueda darte una nueva
              foto. Y que puedas guardarlas como recuerdos especiales... en un
              álbum, o decorando tu espacio.
              <br />
              <br />
            ...
            <div className={subtitle({ class: "mt-6" })}>
              Te prometo hacer todo lo posible para regalarte una nueva fotito
            ...
            <div className="mt-8 space-y-6">
              ...
              <div>
                <h3 className="text-lg font-semibold">
                  ¿Qué cualidad valoro más en una chica?
                </h3>
                <div className="flex flex-col mt-3 space-y-2">
                  {[
                    "Que tenga honestidad, respeto, ganas de querer hacer cosas y valentía.",
              ...
              <div>
                <h3 className="text-lg font-semibold">
                  ¿Qué habilidad me parece más atractiva en una chica?
                </h3>
                <div className="flex flex-col mt-3 space-y-2">
                  {[
        ...
        {step === 7 && (
          <div className="mt-10">
            <h1 className={title({ color: "pink" })}>
              ¿Cuántas crees que acertaste? 🤔
            </h1>
            <p className={subtitle({ class: "mt-2 text-left" })}>
              Haz clic en el botón de abajo para ver cuáles acertaste y una
              pequeña explicación.
            </p>
              ...
              <div className="mt-8 space-y-4 text-sm text-gray-700">
                <div>
                  ...
                  {quizAnswers.age === correctAnswers.age ? (
                    ...
                    <span>
                      {" "}
                      ❌ En realidad tengo {correctAnswers.age} años.
                    </span>
                  )}
                </div>

                <div>
                  <strong>Cualidad más valorada:</strong>{" "}
                  {quizAnswers.qualities}
                  {quizAnswers.qualities === correctAnswers.qualities ? (
                    <span>
                      {" "}
                      ✅ Muy bien, eso es lo que más me importa en una chica.
                    </span>
                  ) : (
                    <span>
                      {" "}
                      ❌ Lo que más valoro es la honestidad, respeto, valentía y
                      ganas de crecer.
                    </span>
                  )}
                </div>
                ...
                <div>
                  ...
                  {quizAnswers.skills === correctAnswers.skills ? (
                    <span>
                      {" "}
                      ✅ ¡Exacto! Me encanta la creatividad artística.
                    </span>
                  ) : (
                    <span>
                      {" "}
                      ❌ Valoro más el arte y la sensibilidad como dibujar o
                      escribir.
                    </span>
                  )}
                </div>
                ...
                <div>
                  ...
                  "Porque me interesas genuinamente." ? (
                    ...
                    <span>
                      {" "}
                      ❌ La verdad es que lo hice porque me interesas de verdad.
                    </span>
                  )}
                </div>
                ...
                <div>
                  ...
                  {quizAnswers.music === correctAnswers.music ? (
                    <span>
                      {" "}
                      ✅ Muy bien, escucho bastante variedad, pero esa lista es
                      la más real.
                    </span>
                  ) : (
                    <span>
                      {" "}
                      ❌ Mi gusto musical es más variado: AfroPop, rap español,
                      Amapiano, etc.
                    </span>
                  )}
                </div>
        ...
        {step === 8 && (
          <div className="mt-10 text-center">
            ...
            <p className="mb-4 text-lg text-gray-600">
              Este pequeño viaje fue una forma especial de compartir algo
              contigo.
            </p>
            <p className="mb-6 text-gray-500 text-md">
              Aprecio mucho que te hayas tomado el tiempo para divertirte un
              poco con mi creacion espero que la haya gustado.
            </p>
            <small className="mb-2">
              Me interesas. No sé qué pasará, pero aquí estoy 🙂
            </small>

            <h1 className="uppercase">
              Life is good… and <br /> you are beautiful.
            </h1>
